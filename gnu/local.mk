...
dist_patch_DATA =						\
  ...
  %D%/packages/patches/citron-fix-build.patch           \
  ...
  %D%/packages/patches/compsize-fix-build.patch			\
  ...
  %D%/packages/patches/libimobiledevice-fix-cython3.patch       \
  ...
  %D%/packages/patches/python-curio-py312.patch		\
  %D%/packages/patches/python-docrepr-fix-tests.patch		\
  %D%/packages/patches/python-feedparser-missing-import.patch	\
  %D%/packages/patches/python-louvain-fix-test.patch		\
  %D%/packages/patches/python-nose-py311.patch                  \
  %D%/packages/patches/python-nose-py312.patch                  \
  ...
  %D%/packages/patches/qtlocation-5-fix-build-with-gcc-14.patch \
