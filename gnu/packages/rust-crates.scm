...
(define rust-aws-lc-sys-0.28.0
  (crate-source "aws-lc-sys" "0.28.0"
                ...
                #:snippet '(for-each delete-file-recursively '("aws-lc" "builder" "generated-include"))))
...
(define rust-bitcode-0.6.0.5f25a59 'rust-bitcode-for-swww)

(define rust-bitcode-derive-0.6.0.5f25a59 'rust-bitcode-for-swww)
...
(define rust-fast-image-resize-3.0.4
  (crate-source "fast_image_resize" "3.0.4"
                "12vyjp14nk49kk25jgbfvl2gyrvp1wzig5jmh9rasd53r3x51m69"))
...
(define rust-spin-sleep-1.3.1
  (crate-source "spin_sleep" "1.3.1"
                "0yshlvkr4y3q6yxi13q0sw2h4pp0ajsw9i4bpywbxgp0yz75xnqp"))
...
(define rust-syntect-5.2.0
  (crate-source "syntect" "5.2.0"
                "1ca68wxr8qs99ivqc266492sz8qwfngswizr7hrh8mlrcfiwykc7"
                #:snippet '(delete-file-recursively "assets")))
...
(define-public aardvark-dns-cargo-inputs
...
(define-public agate-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-anstream-0.6.18
        rust-anstyle-1.0.10
...
(define-public alacritty-cargo-inputs
...
(define-public alfis-cargo-inputs
  (list rust-adler2-2.0.0
        rust-aead-0.5.2
        rust-aes-0.8.4
        rust-aes-gcm-0.10.3
...
(define-public b3sum-cargo-inputs
...
(define-public bankstown-lv2-cargo-inputs
...
(define-public bat-cargo-inputs
  (list rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
...
(define-public bcachefs-tools-cargo-inputs
...
(define-public bottom-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-aho-corasick-1.1.3
...
(define-public breezy-cargo-inputs
  (list rust-aho-corasick-1.1.3
        rust-autocfg-1.4.0
        rust-cfg-if-1.0.0
        rust-heck-0.5.0
...
(define-public c2rust-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-anyhow-1.0.97
...
(define-public cargo-license-cargo-inputs
...
(define-public cargo-machete-cargo-inputs
  (list rust-aho-corasick-1.1.3
        rust-anyhow-1.0.97
        rust-argh-0.1.13
...
(define-public castor-cargo-inputs
...
(define-public circtools-cargo-inputs
  (list rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-alga-0.9.3
        rust-android-tzdata-0.1.1
...
(define-public clamav-cargo-inputs
  (list rust-adler2-2.0.0
        rust-adler32-1.2.0
        rust-aho-corasick-1.1.3
        rust-android-tzdata-0.1.1
...
(define-public codeberg-cli-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-allocator-api2-0.2.21
...
(define-public complgen-cargo-inputs
...
(define-public cyme-cargo-inputs
...
(define-public diffr-cargo-inputs
...
(define-public difftastic-cargo-inputs
...
(define-public drill-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
...
(define-public du-dust-cargo-inputs
  (list rust-aho-corasick-1.1.3
        rust-android-tzdata-0.1.1
        rust-android-system-properties-0.1.5
        rust-ansi-term-0.12.1
...
(define-public fish-cargo-inputs
...
(define-public gitoxide-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-aho-corasick-1.1.3
        rust-allocator-api2-0.2.21
        rust-ansiterm-0.12.2
        rust-anstream-0.6.18
        rust-anstyle-1.0.10
        rust-anstyle-parse-0.2.6
        rust-anstyle-query-1.1.2
        ...
        rust-async-std-1.13.1
        rust-async-task-4.7.1
        rust-async-trait-0.1.88
        rust-atomic-waker-1.1.2
        rust-autocfg-1.4.0
        rust-aws-lc-rs-1.13.0
        rust-aws-lc-sys-0.28.0
        rust-backtrace-0.3.74
        rust-base64-0.22.1
        rust-bindgen-0.69.5
        rust-bitflags-2.9.0
        ...
        rust-gix-worktree-stream-0.20.0
        rust-glob-0.3.2
        ...
        rust-tracing-attributes-0.1.28
        rust-tracing-core-0.1.33
        rust-tracing-forest-0.1.6
        rust-tracing-log-0.2.0
        rust-tracing-subscriber-0.3.19
        rust-try-lock-0.2.5
        rust-tui-react-0.23.2
        rust-typenum-1.18.0
        rust-uluru-3.1.0
        rust-unicode-bom-2.0.3
        rust-unicode-ident-1.0.18
...
(define-public gnome-authenticator-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aead-0.5.2
        rust-aes-0.8.4
...
(define-public greetd-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-async-trait-0.1.88
        rust-backtrace-0.3.74
...
(define-public helix-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-aho-corasick-1.1.3
        ...
        rust-gix-config-0.42.0
        rust-gix-config-value-0.14.12
        rust-gix-date-0.9.4
        rust-gix-diff-0.49.0
        rust-gix-dir-0.11.0
        rust-gix-discover-0.37.0
        rust-gix-features-0.39.1
        rust-gix-filter-0.16.0
        rust-gix-fs-0.12.1
        ...
        rust-gix-object-0.46.1
        rust-gix-odb-0.66.0
        rust-gix-pack-0.56.0
        rust-gix-packetline-0.18.4
        rust-gix-packetline-blocking-0.18.3
        rust-gix-path-0.10.15
        rust-gix-pathspec-0.8.1
        rust-gix-protocol-0.47.0
        rust-gix-quote-0.4.15
        rust-gix-ref-0.49.1
        rust-gix-refspec-0.27.0
        rust-gix-revision-0.31.1
        rust-gix-revwalk-0.17.0
        rust-gix-sec-0.10.12
        rust-gix-shallow-0.1.0
        rust-gix-status-0.16.0
        rust-gix-submodule-0.16.0
        rust-gix-tempfile-15.0.0
        rust-gix-trace-0.1.12
        rust-gix-transport-0.44.0
        rust-gix-traverse-0.43.1
        rust-gix-url-0.28.2
        rust-gix-utils-0.1.14
        rust-gix-validate-0.9.4
...
(define-public jless-cargo-inputs
  (list rust-aho-corasick-1.1.3
        rust-anstream-0.6.18
        rust-anstyle-1.0.10
        rust-anstyle-parse-0.2.6
...
(define-public kak-lsp-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-adler32-1.2.0
        rust-ahash-0.8.11
        ...
        rust-sentry-core-0.35.0
        rust-sentry-debug-images-0.35.0
...
(define-public kanata-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-anstyle-1.0.10
...
(define-public libchewing-cargo-inputs
  (list rust-anstream-0.6.18
        rust-anstyle-1.0.10
        rust-anstyle-parse-0.2.6
        rust-anstyle-query-1.1.2
...
(define-public librsvg-cargo-inputs
  (list rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-android-tzdata-0.1.1
        rust-android-system-properties-0.1.5
...
(define-public matugen-cargo-inputs
  (list rust-addr2line-0.21.0
        ...
        rust-etcetera-0.8.0
        rust-execute-0.2.13
        rust-execute-command-macro-0.1.9
        rust-execute-command-macro-impl-0.1.10
        rust-execute-command-tokens-0.1.7
        rust-exr-1.73.0
        rust-eyre-0.6.12
        rust-fdeflate-0.3.7
        rust-flate2-1.1.1
...
(define-public maturin-cargo-inputs
  (list rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-aho-corasick-1.1.3
        rust-allocator-api2-0.2.21
...
(define-public monolith-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
...
(define-public mudskipper-cargo-inputs
  (list rust-ahash-0.8.11
        rust-aho-corasick-1.1.3
        rust-ansi-term-0.12.1
        rust-anyhow-1.0.97
...
(define-public newsboat-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-android-tzdata-0.1.1
        ...
        rust-curl-sys-0.4.80+curl-8.12.1
        rust-cxx-1.0.156
        rust-cxx-build-1.0.156
        rust-cxxbridge-cmd-1.0.156
        rust-cxxbridge-flags-1.0.156
        rust-cxxbridge-macro-1.0.156
        rust-dirs-next-2.0.0
        rust-dirs-sys-next-0.1.2
        rust-displaydoc-0.2.5
        rust-either-1.15.0
...
(define-public nitrocli-cargo-inputs
  (list rust-aho-corasick-1.1.3
        rust-anyhow-1.0.97
        rust-autocfg-1.4.0
        rust-base32-0.4.0
        ...
        rust-nitrokey-0.9.0
        rust-nitrokey-sys-3.7.0
        rust-nitrokey-test-0.5.0
...
(define-public nsncd-cargo-inputs
  (list rust-aho-corasick-1.1.3
        rust-anes-0.1.6
        rust-anstyle-1.0.10
        rust-anyhow-1.0.97
...
(define-public nu-plugin-formats-cargo-inputs
  (list rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-aho-corasick-1.1.3
        rust-alloc-no-stdlib-2.0.4
...
(define-public nu-plugin-gstat-cargo-inputs
  (list rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-alloc-no-stdlib-2.0.4
        rust-alloc-stdlib-0.2.2
...
(define-public nu-plugin-inc-cargo-inputs
  (list rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-alloc-no-stdlib-2.0.4
        rust-alloc-stdlib-0.2.2
...
(define-public nushell-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-aho-corasick-1.1.3
...
(define-public parinfer-rust-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-ansi-term-0.12.1
...
(define-public parinfer-rust-emacs-cargo-inputs
...
(define-public pijul-cargo-inputs
  (list rust-addr2line-0.24.2
        ...
        rust-cryptovec-0.6.1
        rust-ctr-0.8.0
        rust-ctrlc-3.2.0
        rust-curve25519-dalek-3.2.1
        rust-data-encoding-2.8.0
        rust-dateparser-0.1.8
        rust-derivative-2.2.0
        rust-dialoguer-0.10.4
        rust-diffs-0.5.1
        rust-digest-0.9.0
        rust-digest-0.10.7
        rust-dirs-3.0.2
        ...
        rust-lazy-static-1.5.0
        rust-libc-0.2.171
        rust-libgit2-sys-0.12.26+1.3.0
        rust-libpijul-1.0.0-beta.10
        rust-libredox-0.1.3
        rust-libsodium-sys-0.2.7
        rust-libssh2-sys-0.2.23
        rust-libz-sys-1.1.22
        rust-linked-hash-map-0.5.6
        rust-linux-keyutils-0.2.4
        rust-linux-raw-sys-0.3.8
        ...
        rust-pijul-macros-0.5.0
        rust-pijul-remote-1.0.0-beta.6
        ...
        rust-thrussh-keys-0.21.0
        rust-thrussh-keys-0.22.1
        rust-thrussh-libsodium-0.2.3
        rust-thrussh-libsodium-0.3.0
        rust-tint-1.0.1
        rust-tinystr-0.7.6
        rust-tinyvec-1.9.0
        rust-tinyvec-macros-0.1.1
...
(define-public python-rpds-py-cargo-inputs
...
(define-public rav1e-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-aligned-vec-0.5.0
...
(define-public rust-bitcode-for-swww-cargo-inputs
  (list rust-adler2-2.0.0
        rust-arrayvec-0.7.6
        rust-bincode-1.3.3
        rust-bitflags-2.9.0
...
(define-public rust-cbindgen-0.26-cargo-inputs
  (list rust-atty-0.2.14
        rust-autocfg-1.4.0
        rust-bitflags-1.3.2
        rust-bitflags-2.9.0
...
(define-public rust-cbindgen-0.28-cargo-inputs
  (list rust-anstream-0.6.18
        rust-anstyle-1.0.10
        rust-anstyle-parse-0.2.6
        rust-anstyle-query-1.1.2
...
(define-public rust-minisign-cargo-inputs
...
(define-public rust-pcre2-utf32-0.2-cargo-inputs
...
(define-public rust-pipewire-for-niri-cargo-inputs
  (list rust-aho-corasick-1.1.3
        rust-annotate-snippets-0.9.2
        rust-anstream-0.6.18
        rust-anstyle-1.0.10
...
(define-public rust-pubgrub-for-uv-cargo-inputs
  (list rust-aho-corasick-1.1.3
        rust-anes-0.1.6
        rust-anstream-0.6.18
        rust-anstyle-1.0.10
...
(define-public rust-ring-0.17-cargo-inputs
...
(define-public snafu-cargo-inputs
  (list rust-android-tzdata-0.1.1
        rust-android-system-properties-0.1.5
        rust-autocfg-1.4.0
        rust-bumpalo-3.17.0
...
(define-public starship-cargo-inputs
  (list rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-aho-corasick-1.1.3
        rust-allocator-api2-0.2.21
        ...
        rust-gix-discover-0.35.0
        rust-gix-features-0.38.2
        rust-gix-fs-0.11.3
        rust-gix-glob-0.16.5
        rust-gix-hash-0.14.2
        rust-gix-hashtable-0.5.2
        rust-gix-index-0.35.0
        ...
        rust-gix-revision-0.29.0
        rust-gix-revwalk-0.15.0
        rust-gix-sec-0.10.12
        rust-gix-tempfile-14.0.2
        rust-gix-trace-0.1.12
        rust-gix-traverse-0.41.0
        rust-gix-url-0.27.5
        rust-gix-utils-0.1.14
        rust-gix-validate-0.9.4
        rust-guess-host-triple-0.1.4
        rust-hashbrown-0.12.3
        rust-hashbrown-0.14.5
        rust-hashbrown-0.15.2
        rust-hashlink-0.9.1
        ...
        rust-lock-api-0.4.12
        rust-log-0.4.27
        rust-mac-notification-sys-0.6.4
        rust-mach2-0.4.2
        rust-memchr-2.7.4
        rust-memmap2-0.9.5
        rust-memmem-0.1.1
        ...
        rust-smallvec-1.15.0
        rust-stable-deref-trait-1.2.0
        rust-starship-battery-0.10.1
        rust-static-assertions-1.1.0
        rust-strsim-0.11.1
        rust-syn-1.0.109
        rust-syn-2.0.100
        rust-synstructure-0.13.1
        rust-systemstat-0.2.3
...
(define-public stgit-2-cargo-inputs
  (list rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-allocator-api2-0.2.21
        rust-anstream-0.6.18
...
(define-public swww-cargo-inputs
  (list rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-aligned-vec-0.5.0
        rust-anes-0.1.6
        ...
        rust-avif-serialize-0.8.3
        rust-bit-field-0.10.2
        rust-bitcode-0.6.0.5f25a59
        rust-bitcode-derive-0.6.0.5f25a59
        rust-bitflags-1.3.2
        rust-bitflags-2.9.0
        rust-bitstream-io-2.6.0
        rust-bstr-1.12.0
...
(define-public transanno-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-anstream-0.6.18
...
(define-public tree-sitter-cli-cargo-inputs
  (list rust-adler2-2.0.0
        rust-ahash-0.8.11
        rust-aho-corasick-1.1.3
        rust-allocator-api2-0.2.21
        ...
        rust-core-foundation-0.10.0
        rust-core-foundation-sys-0.8.7
        rust-cranelift-bforest-0.116.1
        rust-cranelift-bitset-0.116.1
        rust-cranelift-codegen-0.116.1
        rust-cranelift-codegen-meta-0.116.1
        rust-cranelift-codegen-shared-0.116.1
        rust-cranelift-control-0.116.1
        rust-cranelift-entity-0.116.1
        rust-cranelift-frontend-0.116.1
        rust-cranelift-isle-0.116.1
        rust-cranelift-native-0.116.1
        rust-crc32fast-1.4.2
        rust-ctor-0.2.9
        rust-ctrlc-3.4.6
        rust-dialoguer-0.11.0
        ...
        rust-proc-macro2-1.0.94
        rust-psm-0.1.25
        rust-pulley-interpreter-29.0.1
        rust-quote-1.0.40
        rust-r-efi-5.2.0
        rust-rand-0.8.5
        rust-rand-chacha-0.3.1
        ...
        rust-wasm-bindgen-macro-support-0.2.100
        rust-wasm-bindgen-shared-0.2.100
        rust-wasm-encoder-0.221.3
        rust-wasmparser-0.221.3
        rust-wasmparser-0.224.1
        rust-wasmprinter-0.221.3
        rust-wasmtime-29.0.1
        rust-wasmtime-asm-macros-29.0.1
        rust-wasmtime-c-api-impl-29.0.1
        rust-wasmtime-c-api-macros-29.0.1
        rust-wasmtime-component-macro-29.0.1
        rust-wasmtime-component-util-29.0.1
        rust-wasmtime-cranelift-29.0.1
        rust-wasmtime-environ-29.0.1
        rust-wasmtime-fiber-29.0.1
        rust-wasmtime-jit-icache-coherence-29.0.1
        rust-wasmtime-math-29.0.1
        rust-wasmtime-slab-29.0.1
        rust-wasmtime-versioned-export-macros-29.0.1
        rust-wasmtime-winch-29.0.1
        rust-wasmtime-wit-bindgen-29.0.1
        rust-web-sys-0.3.77
        rust-webbrowser-1.0.4
        rust-webpki-roots-0.26.8
        rust-widestring-1.2.0
        rust-winapi-util-0.1.9
        rust-winch-codegen-29.0.1
        rust-windows-sys-0.45.0
        rust-windows-sys-0.48.0
        rust-windows-sys-0.52.0
        rust-windows-sys-0.59.0
...
(define-public wallust-cargo-inputs
  (list rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-aligned-vec-0.5.0
        rust-anes-0.1.6
        ...
        rust-displaydoc-0.2.5
        rust-document-features-0.2.11
        rust-documented-0.9.1
        rust-documented-macros-0.9.1
        rust-dunce-1.0.5
        rust-dyn-clone-1.0.19
        rust-either-1.15.0
        rust-equivalent-1.0.2
        ...
        rust-vcpkg-0.2.15
        rust-vergen-9.0.6
        rust-vergen-git2-1.0.7
        rust-vergen-lib-0.1.6
        rust-version-compare-0.2.0
        rust-walkdir-2.5.0
        rust-wallust-themes-1.1.0
        rust-wasi-0.11.0+wasi-snapshot-preview1
        rust-wasi-0.14.2+wasi-0.2.4
        rust-wasm-bindgen-0.2.100
        rust-wasm-bindgen-backend-0.2.100
...
(define-public wlgreet-cargo-inputs
...
(define-public xen-guest-agent-cargo-inputs
  (list rust-addr2line-0.24.2
        rust-adler2-2.0.0
        rust-aho-corasick-1.1.3
        rust-anstream-0.6.18
        ...
        rust-miniz-oxide-0.8.8
        rust-mio-1.0.3
        rust-netlink-packet-core-0.7.0
        rust-netlink-packet-route-0.18.1
        rust-netlink-packet-route-0.19.0
        rust-netlink-packet-utils-0.5.2
        rust-netlink-proto-0.11.5
        rust-netlink-sys-0.8.7
        rust-nix-0.27.1
...
(define-public zoxide-cargo-inputs
  (list rust-aho-corasick-1.1.3
