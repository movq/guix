...
(define-public rust-1.84
  (let ((base-rust (rust-bootstrapped-package rust-1.83 "1.84.1"
...
(define-public rust-1.85
  (let ((base-rust (rust-bootstrapped-package rust-1.84 "1.85.0"
                    "1rx1iv1hkir8ag6a8frchihiy0rdlrf4y9zbqyxaanvv46bw6hnm")))
    (package
      (inherit base-rust)
      (source
       (origin
